...
<body>
  ...
  return (
    <section className="mb-12">
      <h2 className="text-3xl font-semibold mb-8 text-center" style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.6), 0 0 20px rgba(255, 255, 255, 0.4)' }}>
        Seamlessly Deploy Your Website with Smart Contract Technology
      </h2>
        ...
        <Card className="bg-secondary relative overflow-hidden">
          ...
          <CardContent>
            <pre className="bg-background p-4 rounded-md opacity-50">
              <code>$ http3 deploy ./my-website (Coming Soon)</code>
            </pre>
